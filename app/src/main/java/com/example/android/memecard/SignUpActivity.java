...
import com.example.android.memecard.databinding.ActivitySignUpBinding;
                ...
                auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SignUpActivity.this,"User Data Saved Succesfully",Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(SignUpActivity.this,MainActivity.class);
                            startActivity(intent);                        }
                        else{
                            Toast.makeText(SignUpActivity.this,"User Data Saveing Failed",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
