...
import com.example.android.memecard.adapters.FollowersAdapter;
import com.example.android.memecard.databinding.FragmentProfile2Binding;
import com.example.android.memecard.models.Follow;
            ...
            if(data.getData()!=null){
                ...
                reference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(getContext(),"Cover phyoto saved",Toast.LENGTH_SHORT).show();
